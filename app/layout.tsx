...
const description = "Lippa Labs develops AI-assisted products including SpendFence, GigWise, and TradersDelight across finance, markets, productivity, and behavioral systems.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Lippa Labs | SpendFence, GigWise, and TradersDelight",
    description,
    url: siteUrl,
    siteName: "Lippa Labs",
    type: "website",
